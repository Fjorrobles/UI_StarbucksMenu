...
def web_scraper():
    url = 'https://starbucksmenuprice.net'  # URL to scrape from
    data_file = "./app/data/menu.json"  # Path to save the JSON data
    ...
    if response.status_code == 200:
        ...
        # Extracting all 'strong' elements (or adjust this if needed)
        ...
        for name in name_elements:
            ...
            if name_text:  # Avoid adding empty strings
